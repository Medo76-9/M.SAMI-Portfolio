  ...
  const timeline = [
    {
      ...
      description:
        "Fresh out of design school, armed with dreams and a MacBook.",
    },
    {
      year: "2018",
    ...
    },
    {
      ...
      description:
        "Took the leap into full-time freelancing. Best decision ever!",
    },
    {
      year: "2022",
      title: "Award Season",
      description:
        "Won multiple design awards and grew an amazing client base.",
    },
    {
      year: "Now",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <AnimatedSection direction="left">
                ...
                <p className="text-lg text-muted-foreground mt-6 leading-relaxed">
                  I'm a creative soul who believes that great design should
                  evoke emotions, tell stories, and most importantly—make people
                  smile. With a background in fine arts and a passion for
                  digital experiences, I bridge the gap between artistic
                  expression and functional design.
                </p>
                <p className="text-lg text-muted-foreground mt-4 leading-relaxed">
                  When I'm not pushing pixels, you'll find me exploring new
                  coffee shops, sketching in my notebook, or getting way too
              ...
              <AnimatedSection direction="right" className="relative">
                ...
                >
                  <img
                    ...
                    src="/photos-uploads/79cda72e-9104-4019-9203-0f1556847cab.png"
                    className="w-full aspect-square object-cover border-0 border-none"
                  />
