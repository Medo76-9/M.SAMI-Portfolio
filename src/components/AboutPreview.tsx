        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <AnimatedSection delay={0.1}>
              <p className="text-lg text-muted-foreground leading-relaxed">I’m a Senior Graphic Designer with 5+ years of hands-on experience, focused on turning ideas into visually engaging and impactful designs.
I love creating work that feels fun, bold, and authentic—helping brands express themselves clearly and creatively.</p>
            </AnimatedSection>
