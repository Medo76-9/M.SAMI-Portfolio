  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 pt-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          delay: 0.5,
          duration: 0.6
        }} className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12">Senior Graphic Designer crafting bold, playful, and unforgettable visual stories for brands that dare to be different.</motion.p>
          ...
          delay: 0.7
            ...
            <Link to="/contact">
              ...
              scale: 0.95
            }} className="px-8 py-4 border-2 border-foreground/20 text-foreground font-display font-bold rounded-full text-lg hover:border-secondary hover:text-secondary transition-colors" data-cursor="Let's Talk">
                Let's chat!
              </motion.button>
            </Link>
          </motion.div>
      ...
      {/* Decorative elements */}
      <motion.div className="absolute top-1/4 left-10 w-4 h-4 bg-secondary rounded-full" animate={{
      scale: [1, 1.5, 1],
      opacity: [0.5, 1, 0.5]
    }} transition={{
      duration: 2,
      ...
      <motion.div className="absolute bottom-1/3 right-10 w-6 h-6 bg-accent rounded-sm rotate-45" animate={{
      rotate: [45, 90, 45],
      scale: [1, 1.2, 1]
    }} transition={{
      duration: 3,
      ...
      <motion.div className="absolute top-1/3 right-1/4 w-3 h-3 bg-tertiary rounded-full" animate={{
      y: [0, -20, 0],
      x: [0, 10, 0]
    }} transition={{
      duration: 4,
