      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12 border-t border-border/30">
          <AnimatedSection delay={0.1}>
            ...
            <p className="text-muted-foreground text-sm">
              Creating bold, playful, and unforgettable designs since 2016.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.2}>
            ...
            <ul className="space-y-2">
              {['Home', 'About', 'Portfolio', 'Services', 'Process', 'Contact'].map((item) => (
                <li key={item}>
                  <Link
          ...
          <AnimatedSection delay={0.3}>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href="mailto:hello@pixel.design" className="hover:text-primary transition-colors">
                  hello@pixel.design
                </a>
              </li>
              <li>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-12 h-12 bg-muted rounded-full flex items-center justify-center text-xl hover:bg-primary/20 transition-colors"
        ...
        <div className="pt-8 border-t border-border/30 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          ...
          <p className="flex items-center gap-2">
            Made with <motion.span animate={{ scale: [1, 1.2, 1] }} transition={{ duration: 1, repeat: Infinity }}>❤️</motion.span> and lots of coffee
          </p>
        </div>
      </div>
